...
/* 677C0 8018BFC0 -O2 */
static void calc_obj_pos_map_wm(Obj *obj)
{
...
static void DO_SCROLL_MAP_wm(s16 h_speed, s16 v_speed)
{
    ymap += v_speed;
    xmap += h_speed;
...
void DO_CHEMIN(void)
{
    ...
    DO_MEDAILLONS();
    recale_ray_pos();
    DO_SCROLL_MAP_wm(h_scroll_speed, v_scroll_speed);
    DO_STAGE_NAMES();
}
